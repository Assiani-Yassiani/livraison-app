  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      children: [
        ...
        const Text("Fast Delivery Application",
            style: TextStyle(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: const Color.fromARGB(255, 17, 174, 179), // Coin arrondi
              ),
              child: Center(
                child: InkWell(
                  onTap: () {
            ...
            Row(
              ...
              children: [
                ...
                const Text(
                  "Or",
                  style: TextStyle(
                      fontSize: 17, color: Color.fromARGB(255, 111, 110, 110)),
                ),
                Container(
                    width: 20.0,
                    child: const Divider(
